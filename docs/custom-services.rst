Custom Services
===============
Flask-Dance allows you to build authentication blueprints for any custom OAuth
service, not just the :doc:`pre-set configurations <contrib>`.
For these examples, we'll reimplement the Github configuration,
